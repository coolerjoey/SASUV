...
static void mavlink_test_tasklists(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TASKLISTS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_tasklists_t packet_in = {
        17235,17339,17443,17547,17651,17755,17859,17963,53,120,187,254,65,132,199,10,77,144,211,22,89,156,223,34
    };
    mavlink_tasklists_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.task_1_value = packet_in.task_1_value;
        packet1.task_2_value = packet_in.task_2_value;
        packet1.task_3_value = packet_in.task_3_value;
        packet1.task_4_value = packet_in.task_4_value;
        packet1.task_5_value = packet_in.task_5_value;
        packet1.task_6_value = packet_in.task_6_value;
        packet1.task_7_value = packet_in.task_7_value;
        packet1.task_8_value = packet_in.task_8_value;
        packet1.task_1 = packet_in.task_1;
        packet1.task_1_duration = packet_in.task_1_duration;
        packet1.task_2 = packet_in.task_2;
        packet1.task_2_duration = packet_in.task_2_duration;
        packet1.task_3 = packet_in.task_3;
        packet1.task_3_duration = packet_in.task_3_duration;
        packet1.task_4 = packet_in.task_4;
        packet1.task_4_duration = packet_in.task_4_duration;
        packet1.task_5 = packet_in.task_5;
        packet1.task_5_duration = packet_in.task_5_duration;
        packet1.task_6 = packet_in.task_6;
        packet1.task_6_duration = packet_in.task_6_duration;
        packet1.task_7 = packet_in.task_7;
        packet1.task_7_duration = packet_in.task_7_duration;
        packet1.task_8 = packet_in.task_8;
        packet1.task_8_duration = packet_in.task_8_duration;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TASKLISTS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TASKLISTS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_tasklists_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_pack(system_id, component_id, &msg , packet1.task_1 , packet1.task_1_duration , packet1.task_1_value , packet1.task_2 , packet1.task_2_duration , packet1.task_2_value , packet1.task_3 , packet1.task_3_duration , packet1.task_3_value , packet1.task_4 , packet1.task_4_duration , packet1.task_4_value , packet1.task_5 , packet1.task_5_duration , packet1.task_5_value , packet1.task_6 , packet1.task_6_duration , packet1.task_6_value , packet1.task_7 , packet1.task_7_duration , packet1.task_7_value , packet1.task_8 , packet1.task_8_duration , packet1.task_8_value );
    mavlink_msg_tasklists_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.task_1 , packet1.task_1_duration , packet1.task_1_value , packet1.task_2 , packet1.task_2_duration , packet1.task_2_value , packet1.task_3 , packet1.task_3_duration , packet1.task_3_value , packet1.task_4 , packet1.task_4_duration , packet1.task_4_value , packet1.task_5 , packet1.task_5_duration , packet1.task_5_value , packet1.task_6 , packet1.task_6_duration , packet1.task_6_value , packet1.task_7 , packet1.task_7_duration , packet1.task_7_value , packet1.task_8 , packet1.task_8_duration , packet1.task_8_value );
    mavlink_msg_tasklists_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_tasklists_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_send(MAVLINK_COMM_1 , packet1.task_1 , packet1.task_1_duration , packet1.task_1_value , packet1.task_2 , packet1.task_2_duration , packet1.task_2_value , packet1.task_3 , packet1.task_3_duration , packet1.task_3_value , packet1.task_4 , packet1.task_4_duration , packet1.task_4_value , packet1.task_5 , packet1.task_5_duration , packet1.task_5_value , packet1.task_6 , packet1.task_6_duration , packet1.task_6_value , packet1.task_7 , packet1.task_7_duration , packet1.task_7_value , packet1.task_8 , packet1.task_8_duration , packet1.task_8_value );
    mavlink_msg_tasklists_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_tasklists_about(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TASKLISTS_ABOUT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_tasklists_about_t packet_in = {
        5,72
    };
    mavlink_tasklists_about_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.task_run = packet_in.task_run;
        packet1.task_return = packet_in.task_return;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TASKLISTS_ABOUT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TASKLISTS_ABOUT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_about_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_tasklists_about_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_about_pack(system_id, component_id, &msg , packet1.task_run , packet1.task_return );
    mavlink_msg_tasklists_about_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_about_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.task_run , packet1.task_return );
    mavlink_msg_tasklists_about_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_tasklists_about_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tasklists_about_send(MAVLINK_COMM_1 , packet1.task_run , packet1.task_return );
    mavlink_msg_tasklists_about_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_data_time(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_DATA_TIME >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_data_time_t packet_in = {
        5,72,139,206,17,84,151
    };
    mavlink_data_time_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_DATA_TIME_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_DATA_TIME_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_data_time_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_data_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_data_time_pack(system_id, component_id, &msg , packet1.year , packet1.month , packet1.day , packet1.hour , packet1.minute , packet1.second , packet1.week );
    mavlink_msg_data_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_data_time_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.year , packet1.month , packet1.day , packet1.hour , packet1.minute , packet1.second , packet1.week );
    mavlink_msg_data_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_data_time_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_data_time_send(MAVLINK_COMM_1 , packet1.year , packet1.month , packet1.day , packet1.hour , packet1.minute , packet1.second , packet1.week );
    mavlink_msg_data_time_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_tasklists(system_id, component_id, last_msg);
    mavlink_test_tasklists_about(system_id, component_id, last_msg);
    mavlink_test_data_time(system_id, component_id, last_msg);
}
